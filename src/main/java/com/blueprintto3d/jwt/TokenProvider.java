...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = TimeUnit.MINUTES.toMillis(30);
    private static final long REFRESH_TOKEN_EXPIRE_TIME = TimeUnit.DAYS.toMillis(14);
